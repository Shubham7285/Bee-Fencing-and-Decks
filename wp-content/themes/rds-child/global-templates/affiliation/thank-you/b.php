...
if (is_array($get_alt_text)) {
    foreach ($get_alt_text as $value) {
        if (in_array("affiliate-logo-1.webp", $value) && isset($value[3])) {
            $alt1 = 'alt="' . $value[3] . '"';
        }
        if (in_array("affiliate-logo-2.webp", $value) && isset($value[3])) {
            $alt2 = 'alt="' . $value[3] . '"';
        }
        if (in_array("affiliate-logo-3.webp", $value) && isset($value[3])) {
            $alt3 = 'alt="' . $value[3] . '"';
        }
        if (in_array("affiliate-logo-4.webp", $value) && isset($value[3])) {
            $alt4 = 'alt="' . $value[3] . '"';
        }
        if (in_array("affiliate-logo-5.webp", $value) && isset($value[3])) {
            $alt5 = 'alt="' . $value[3] . '"';
        }
        if (in_array("affiliate-logo-6.webp", $value) && isset($value[3])) {
            $alt6 = 'alt="' . $value[3] . '"';
        }
    }
}
...
<?php endif; ?>
        ...
        <div class="col-12">
            <div class="swiper affiliation-swiper">
                    ...
                    while ($Count >= $i) {
                        ...
                        <div class="swiper-slide">
                            <div class="text-center">
                                <img src="<?php echo $logo; ?>" class="img-fluid" width="160" height="160"
                                     srcset="<?php echo $logo; ?> 1x, <?php echo $logo2x; ?> 2x, <?php echo $logo3x; ?> 3x,"
                                     <?php echo $alt; ?> />
                            </div>
                        </div>
                        <?php
                ...
                <div class="swiper-button-next affiliation_next"></div>
                <div class="swiper-button-prev affiliation_prev"></div>
            </div>
        </div>
    </div>
</div>
