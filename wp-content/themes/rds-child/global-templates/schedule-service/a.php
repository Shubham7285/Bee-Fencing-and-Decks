      ...
      <div class="container">
        <div class="row">
          <div class="col-12 schedule_service_form">
            ...
            <div class="d-lg-flex d-none w-100 schedule_accordion position-relative my-0 rpx_gap_40">
              <?php
            ...
            <div class="d-lg-none d-block accordion w-100 schedule_service_accord position-relative my-0 rpx_px_8" id="schedule_service_accordion">
              <?php
              if (!empty($args["page_templates"]["schedule_service_page"]["first_icon_class"])) {
                echo '<div class="accordion-item col-lg-4 border-0 mb-4 pb-2 bg-transparent">
                  <div class="border-0 d-flex align-items-center justify-content-between accordion-header curson-pointer" id="heading1" data-bs-toggle="collapse" data-bs-target="#collapse1">
                    ...
                    <div id="accoordion_iconn" class=" schedule_service_accrdion_icon d-inline-flex align-items-center"><i class="icon-plus1 text_20 line_height_18"></i></div>
                  </div>
