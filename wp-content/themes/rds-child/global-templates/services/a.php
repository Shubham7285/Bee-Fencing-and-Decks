...
<div class="container-fluid px-0 rpx_py_40 rpx_py_lg_80 color_primary_bg services_section">
 <div class="container rpx_px_0">
	 <?php if($heading){ ?>
 <h2 class="rpx_mb_20 text-center"><?php echo $heading; ?></h2>
  <?php } ?>
          ...
          ?>
                            <div class="swiper-slide text-start true_white_bg rpx_radius_10 rpx_p_30 rpx_small_shadow">
                                <div class="services-prop-items">
                                        <div class="rpx_mb_20 d-flex flex-row align-items-center justify-content-between"><h5 class="color_secondary mb-0"><?php echo $services['title']; ?></h5><i class="icon-circle-check4 text_50 line_height_57 color_primary"></i></div>
